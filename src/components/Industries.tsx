...
const industries = [
  {
    ...
    title: 'Energetika',
    desc: 'Optimiziramo procese, povećavamo pouzdanost i podržavamo održivu energetsku budućnost.',
    image: '/industries/energetika.jpg',
  },
  {
    icon: <path d="M9 18h30M13 18V40M35 18V40M7 40h34M24 8l17 10H7L24 8ZM20 40V28h8v12" />,
    title: 'Javni sektor',
    desc: 'Digitaliziramo usluge i procese te povećavamo učinkovitost i transparentnost.',
    image: '/industries/javni-sektor.jpg',
  },
  {
  ...
  },
  {
    ...
    title: 'Financije',
    desc: 'Pružamo analitička rješenja za bolje odluke i upravljanje rizicima u stvarnom vremenu.',
    image: '/industries/financije.jpg',
  },
  {
    icon: <path d="M24 5 11 25h10l-4 18 20-25H26l4-13Z" />,
  ...
  },
  {
    ...
    title: 'Bankarstvo',
    desc: 'Ubrzavamo digitalnu transformaciju uz najviše standarde sigurnosti i usklađenosti.',
    image: '/industries/bankarstvo.jpg',
  },
  {
    ...
    desc: 'Povećavamo produktivnost, smanjujemo troškove i unaprjeđujemo kvalitetu proizvodnje.',
    image: '/industries/industrija.jpg',
  },
  {
    icon: <path d="M8 16h28v16H8V16Zm28-8h4v28h-4V8Zm-36 8h4v20H0V16Zm8-8h8v36h-8V8Z" />,
    title: 'Logistika i transport',
    desc: 'Optimiziramo lance opskrbe i isporuke za brže, učinkovitije i pouzdanije poslovanje.',
    image: '/industries/logistika.jpg',
  },
]
        ...
        <div className="industries-grid" aria-label="Industrije">
          {industries.map((ind) => (
            <article
              ...
              style={{
                backgroundImage: `url('${p(ind.image)}')`,
              }}
            >
