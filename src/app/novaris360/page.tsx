          ...
          <div className="section">
            ...
            <div className="n360-process-row">
              {[
                ...
                { num: '05', title: 'Unapređenje', desc: 'Kontinuirano savjetujemo o novim procesima i tehnologijama.' },
              ].map((step, i, arr) => (
                ...
                <div className="about-cta-info" style={{ marginTop: 4 }}>
                  <span>
                    <span className="cta-info-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="var(--blue)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  ...
                  <span>
                    <span className="cta-info-icon">
                      <svg viewBox="0 0 24 24" fill="none" stroke="var(--blue)" strokeWidth="2" aria-hidden="true">
